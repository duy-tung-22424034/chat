...
public class SendFile extends javax.swing.JFrame {
    ...
    private ArrayList<String> sendToList = new ArrayList<String>();
    ...
    */
                ...
                while(!Thread.currentThread().isInterrupted()){
                    ...
                    switch(cmd){
                        ...
                        case "CMD_RECEIVE_FILE_ACCEPT":  // Format: CMD_RECEIVE_FILE_ACCEPT [Message]
                            ...
                            new Thread(new FileSendingThread(socket, file, sendTo, myusername, SendFile.this)).start();
                            break;
    ...
    private void initComponents() {
        ...
        btnSendFile.setBackground(new java.awt.Color(102, 102, 102));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(progressbar, javax.swing.GroupLayout.DEFAULT_SIZE, 194, Short.MAX_VALUE)
    ...
    private void btnSendFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendFileActionPerformed
        ...
        sendTo = jComboBox2.getSelectedItem().toString();
