...
public class SocketHandlingThread implements Runnable {
    ...
    public SocketHandlingThread(Socket socket, MainForm main) {
        this.main = main;
        this.socket = socket;
    ...
    /*
     * This method will get the client socket in client socket list then stablish a
     * connection
     */
    private void createConnection(String receiver, String sender, String filename) {
        try {
            ...
            Socket s = main.getSocket(receiver);
            if (s != null) { // Client was exists
                ...
                dos.writeUTF("CMD_SENDFILEERROR " + "Client '" + receiver
                        + "' was not found in the list, make sure it is on the online list.!");
            }
        } catch (IOException e) {
            ...
            while (true) {
                ...
                switch (CMD) {
                    ...
                    case "CMD_CHAT":
                        ...
                        Socket tsoc = main.getSocket(sendTo);
                        try {
                    ...
                    case "CMD_CHATALL":
                        ...
                        for (int x = 0; x < main.getClients().size(); x++) {
                            if (!main.getClients().elementAt(x).equals(chatall_from)) {
                                try {
                                    Socket tsoc2 = (Socket) main.getSockets().elementAt(x);
                    ...
                    case "CMD_SHARINGSOCKET":
                        main.appendMessage(
                                "CMD_SHARINGSOCKET : Client stablish a socket connection for file sharing...");
                    ...
                    case "CMD_SEND_FILE_ERROR": // Format: CMD_SEND_FILE_ERROR [receiver] [Message]
                        ...
                        try {
                            ...
                            Socket eSock = main.getClientFileSharingSocket(eReceiver); // get the file sharing host
